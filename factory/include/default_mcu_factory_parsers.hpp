...
namespace mcu_factory {
	...
	public:
		...
		DefaultMcuFactoryParsers() = default;
		DefaultMcuFactoryParsers(const DefaultMcuFactoryParsers& other) = default;
		DefaultMcuFactoryParsers& operator=(const DefaultMcuFactoryParsers& other) = default;
		...
		DefaultMcuFactoryParsers *clone() const override;
	};
}
...
// 		const mcu_factory::McuFactoryParsers<GpioId, TaskId, TestFactory::TaskType>& parsers() const {
