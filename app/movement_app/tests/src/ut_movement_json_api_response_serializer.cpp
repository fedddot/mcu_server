...
TEST(ut_movement_json_api_response_serializer, ctor_dtor_sanity) {
	...
	ASSERT_NO_THROW(
		(
			instance = new MovementJsonApiResponseSerializer(
...
TEST(ut_movement_json_api_response_serializer, parse_config_request) {
	// GIVEN
	...
	// WHEN
	MovementJsonApiResponseSerializer instance(
...
TEST(ut_movement_json_api_response_serializer, parse_linear_movement_request) {
    // GIVEN
...
TEST(ut_movement_json_api_response_serializer, parse_rotational_movement_request) {
    // GIVEN
